    ...
    <div class="row">
        <div class="col-md-8">
            <?php if ($userType === 'supplier'): ?>
                ...
                <?php
                $total = $price / 2 + $deliveryCharge;
                $finalTotal = max(0, $total);
                ?>
                <p id="price">coins:
                    <?php echo $price / 2; ?>
                </p>
                ...
                <div style=" margin-top: 20px;">
                    ...
                    <script>
                        function updateQuantity() {
                            var newQuantity = parseInt(document.getElementById('quantityInput').value) || 1;
                            document.getElementById('selectedQuantity').innerText = newQuantity;

                            // Your existing calculation logic here (recalculate total based on new quantity)
                        }
                    </script>
            ...
            <?php else: ?>
                ...
                $finalTotal = max(0, $total - $coin);
                ?>
                <p id="price">Price per item: ₹
                    <?php echo $price; ?>
                </p>
                ...
                <p id="subtotal1">total: ₹
                    <?php echo $total; ?>
                </p>

                <button type="button" class="btn btn-outline-danger" id="coin">
                    Use coins
                </button>
                <div id="coinsInputContainer" style="display: none; margin-top: 5px;">
                    <input type="number" id="coinsInput" placeholder="Coins" style="width: 70px;">
                </div>
                <span id="walletBalance" style="margin-left: 10px;">Wallet Balance: ₹
                    <?php echo $userDetails['walletbalance']; ?>
                </span>
                </p>
